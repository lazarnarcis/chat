<?php
  ...
  while ($query->fetch()):
    ...
    $sqls = "INSERT INTO notifications (text, userid) VALUES ('(".$username.") <b>$user_name</b> closed your ticket!', '$userid')";
    $querys = mysqli_query($link,$sqls);
    $sqlsx = "INSERT INTO notifications (text, userid) VALUES ('(".$user_name.") You closed <b>$username</b>\'s ticket.', '$user__id')";
