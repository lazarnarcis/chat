<?php
  ...
  while ($query->fetch()):
    ...
    $sqls = "INSERT INTO notifications (text,userid) VALUES ('(".$username.") ".$_SESSION['username']." unbanned you.', '".$message_id."')";
    $querys = mysqli_query($link,$sqls);
    $sqls = "INSERT INTO notifications (text,userid) VALUES ('(".$_SESSION['username'].") You unbanned ".$username.".', '".$_SESSION['id']."')";
    $querys = mysqli_query($link,$sqls);
