<?php
  ...
  while ($query->fetch()):
    ...
    $sqls = "INSERT INTO notifications (text, userid) VALUES ('(".$username.") $user_name opened your ticket!', '$userid')";
    $querys = mysqli_query($link,$sqls);
    $sqlsx = "INSERT INTO notifications (text, userid) VALUES ('(".$user_name.") You opened $username\'s ticket.', '$user__id')";
