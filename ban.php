<?php
  ...
  while ($query->fetch()):
    ...
    $sqls = "INSERT INTO notifications (texts,userid) VALUES ('(".$username.") ".$_SESSION['username']." banned you.', '".$message_id."')";
    $querys = mysqli_query($link,$sqls);
    $sqls = "INSERT INTO notifications (texts,userid) VALUES ('(".$_SESSION['username'].") You banned ".$username.".', '".$_SESSION['id']."')";
    $querys = mysqli_query($link,$sqls);
