...
<body>
	...
	<div class="terms">
		...
		<br />
		<span>At registration you will enter the following data: username, email, password, your gender and phone number (optional).</span>
		<br />
		...
		<br />
		<span>As mentioned above, the phone number is not required, so all you have to do is enter your email address, gender and click on that box to agree to our terms and conditions.</span>
		<br />
